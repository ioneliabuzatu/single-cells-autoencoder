...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"day2regressor#COMP{config.latent_space}b{config.batch_size}",
...
for epoch in range(1, n_epochs):
    ...
    torch.save(regressor.state_dict(), f"{base_dir}/checkpoints/comp_day2_one_regressor_to_rule_them_all.pth")