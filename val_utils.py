...
def val(epoch, val_loader, device, autoencoder, loss_fn_autoencoder, also_regressor=False):
    autoencoder.eval()
    ...
    return epoch_val_mse_autoencoder, None, None # return mse regressor and corr score