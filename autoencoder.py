...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"MinMaxX#batchNORM+SELU#autoencoder_batch#{config.batch_size}",
...
for epoch in range(n_epochs):
    ...
    with torch.no_grad():
        ...
        run.log({"val/mse": epoch_val_mse.mean()})
        del epoch_val_mse
        ...
        run.log({"val/correlation": correlation_score})
