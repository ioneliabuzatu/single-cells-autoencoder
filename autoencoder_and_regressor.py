...
import config
from model import Autoencoder, Regressor, AutoencoderV2, VariationalAutoencoder
...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"!!!scheduler...#COMP{config.latent_space}b{config.batch_size}",
...
optimizer_autoencoder = optim.Adam(autoencoder.parameters(), lr=0.01)
...
lambda_scheduler = lambda epoch: 0.67 ** epoch
