...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"!!!standnrom 1_regressor to rule them all...#COMP{config.latent_space}b{config.batch_size}",
...
test_loader = DataLoader(TestDataset(cite_test_inputs), batch_size=100, shuffle=False, drop_last=False)
