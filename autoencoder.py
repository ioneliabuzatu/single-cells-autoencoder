...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"SELU#autoencoder_batch#{config.batch_size}",
...
for epoch in range(n_epochs):
    ...
    run.log({"metrics/mse_epoch": losses_epoch.mean(), 'epoch': epoch})
    del losses_epoch
    ...
    with torch.no_grad():
        ...
        run.log({"correlation": correlation_score})
