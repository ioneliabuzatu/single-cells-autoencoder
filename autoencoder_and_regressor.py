...
buddy = experiment_buddy.deploy(
    ...
    wandb_run_name=f"NAME#100latent#CoupledRegressor#sumMSE#50latent#batchNORM+SELU#autoencoder_batch#{config.batch_size}",
...
for epoch in range(n_epochs):
    ...
    # ---------------------------------------- eval ------------------------------------------------- #
    epoch_val_mse_autoencoder, _, _ = val(
        epoch, val_loader, device, autoencoder, loss_fn_autoencoder, also_regressor=False
    )
